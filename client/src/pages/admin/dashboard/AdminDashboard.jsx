...
function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const url = "http://localhost:3000/user/get-all-users"; // Assuming the endpoint is corrected to "/user/get-all-users"
    axios
      .get(url, {
        headers: {
  ...
  const openPermissionsModal = (user) => {
    const token = localStorage.getItem("admin-token");
    axios
      .get(`http://localhost:3000/user/get-user-permissions/${user.user_id}`, {
        headers: {
